...
# else:
#     C.load("config/yaya11.json").create_fresh_workspace()
...
plot_data.main([
    ...
    # "tmp/yaya7.2.2/bftq/results",
    # "tmp/yaya7.2/bftq/results",
    # "tmp/yaya12.2/bftq/results",
    # "tmp/yaya12/bftq/results",
    # "tmp/yaya12/hdc/results",
    # "tmp/yaya12.2/hdc/results",
    "tmp/yaya11.2/bftq/results",
    "tmp/yaya11/bftq/results",
    # "tmp/yaya11/hdc/results",
    # "tmp/yaya11.2/hdc/results",
    "tmp/yaya11/ftq/results",
    "tmp/yaya11.2/ftq/results",

    # "tmp/yaya7.2.2/ftq/results",
    # "tmp/yaya7.2/ftq/results",
