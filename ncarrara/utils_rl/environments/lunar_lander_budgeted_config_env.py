...
class LunarLanderBudgetedConfigEnv(gym.Env, EzPickle):
    ID="LunarLanderBudgetedConfig-v0"
    ...
    def __init__(self, main_engine_power=13.0, side_engine_power=0.6):
    ...
    def step(self, action):
        ...
        # reward -= s_power * 0.03
        constraint = 0
        constraint += m_power * 0.30
        constraint += s_power * 0.03
        ...
        if not self.lander.awake:
            ...
            reward = +100
        return np.array(state, dtype=np.float32), reward, done, {"c_":constraint}
